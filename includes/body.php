<body>
  ...
  ?>
    ...
    <div class="hero-wrap js-fullheight" style="background-image: url('images/ch2.jpg');">
    				...
    				<div class="single-slider owl-carousel ftco-animate">
    					<div class="item">
		    				<div class="destination">
		    					<a href="#" class="img d-flex justify-content-center align-items-center" style="background-image: url(images/ch3.jpg);">
                                   ...
                                   <div class='destination'>
                                     ...
                                     <div class='text p-3'>
                                       ...
                                       <p class='bottom-area d-flex'>
                                         <span><i class='icon-map-o'></i> Chetan</span> 
    ...
    <section class="ftco-section ftco-counter img" id="section-counter" style="background-image: url(images/ch9.jpg)">
    	<div class="container">
		            ...
		            <div class="carousel-testimony owl-carousel">
		              <div class="item">
		                <div class="testimony-wrap d-flex">
		                  <div class="user-img mb-5" style="background-image:url(images/ch1.jpg)">
		                  ...
		                  <div class="text ml-md-4">
		                    <p class="mb-5">Dr .jayakumar.s,Assistant Professor Sr. Grade 1,Department of Software and Systems Engineering,School of Information Technology and Engineering,jayakumars@vit.ac.in,SJT-510-A03.</p>
		                    <p class="name">Dr. jayakumar.s</p>
